...
import com.ranga.minilibrary.inventory.dto.InventoryContactInfoDto;
...
public class WelcomeController {
    ...
    @Autowired
    InventoryContactInfoDto inventoryContactInfoDto;
    ...
    public ResponseEntity<InventoryContactInfoDto> contact() {
        return ResponseEntity.ok(inventoryContactInfoDto);
    }
